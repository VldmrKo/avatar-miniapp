    ...
    area.addEventListener("input", function () {
      ...
      timer = setTimeout(function () {
        ...
        api("/api/estimate", {
          ...
          if (r.over) {
            // Предупреждение, а не запрет: отправить всё равно можно.
            // Отказ на входе люди принимали хуже, чем кривой результат.
            out.textContent = "Длинно — в ролик войдёт около "
                            + Math.round(r.limit_seconds) + " с, конец может смазаться";
